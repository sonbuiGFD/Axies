...
(function ($) {
  ...
  $('.dark').on('click', function (e) {
    ...
    $('.tf-text').addClass('s1');
    document.getElementById('logo_header').src = '/images/logo/logo_dark.png';
    document.getElementById('logo_footer').src = '/images/logo/logo_dark.png';
    document.getElementById('moon_dark').src = '/images/icon/moon-2.png';
  });
  ...
  $('.light').on('click', function (e) {
    ...
    document.getElementById('logo_header').src = '/images/logo/logo.png';
    document.getElementById('logo_footer').src = '/images/logo/logo2.png';
    document.getElementById('moon_dark').src = '/images/icon/moon.png';
  });
